package com.crone.skillbranchtest.ui.custom_views.dotprogress;

/**
 * Created by CRN_soft on 24.10.2016.
 */
...
public class DotProgressBar extends View {
    ...
    public void startAnimation() {
        this.post(new Runnable() {
            @Override
            public void run() {
                DotProgressBar.super.setVisibility(VISIBLE);
                DotProgressBar.BounceAnimation bounceAnimation = new DotProgressBar.BounceAnimation();
